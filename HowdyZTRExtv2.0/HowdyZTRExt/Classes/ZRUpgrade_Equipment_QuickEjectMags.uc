class ZRUpgrade_Equipment_QuickEjectMags extends WMUpgrade_Equipment;
...
defaultproperties
{
	...
	upgradeDescription(0)="Increase Reload Speed by %x%"
	...
	Name="Default__ZRUpgrade_Equipment_QuickEjectMags"
}
