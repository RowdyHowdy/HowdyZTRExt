class ZRUpgrade_Skill_Immunity extends WMUpgrade_Skill;
...
defaultproperties
{
	...
	upgradeName="Lab-Tested Immunity"
	...
	upgradeDescription(0)="Increase resistance to fire, sonic, EMP and poison damages by 15%"
	upgradeDescription(1)="Increase resistance to fire, sonic, EMP and poison damages by <font color=\"#b346ea\">30%</font>"
	...
	upgradeIcon(0)=Texture2D'GuardianPerkPackage.Guardian_berzerker_N'
	upgradeIcon(1)=Texture2D'GuardianPerkPackage.Guardian_berzerker_D'
	...
	Name="Default__ZRUpgrade_Skill_Immunity"
}
