class ZRUpgrade_Skill_ConvenientMalfunction_Helper extends Info
	transient;
...
function Explosion()
{
	...
	if (bDeluxe)
		Player.Controller.Spawn(class'HowdyZTRExt.ZRProj_EMPExplosion_Deluxe', Player.Controller, , Loc, Rot, , True);
	else
		Player.Controller.Spawn(class'HowdyZTRExt.ZRProj_EMPExplosion', Player.Controller, , Loc, Rot, , True);
	PlayLocalEffects();
...
defaultproperties
{
	...
	Name="Default__ZRUpgrade_Skill_ConvenientMalfunction_Helper"
}
