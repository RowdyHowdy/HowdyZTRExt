class ZRUpgrade_Skill_ColdStep_Helper extends Info
	transient;
...
function Timer()
{
	...
	else
	{
		if (bDeluxe)
		{	
			Spawn(class'HowdyZTRExt.ZRProj_GroundIce', , , Player.Location, Player.Rotation, , True);
		}
		else
			Spawn(class'HowdyZTRExt.ZRProj_GroundIce_Deluxe', , , Player.Location, Player.Rotation, , True);
...
defaultproperties
{
	...
	Name="Default__ZRUpgrade_Skill_ColdStep_Helper"
}
