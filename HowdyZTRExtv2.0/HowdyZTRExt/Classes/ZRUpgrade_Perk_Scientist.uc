Class ZRUpgrade_Perk_Scientist extends WMUpgrade_Perk;
...
defaultproperties
{
	...
	upgradeDescription(0)="+%x%% Damage over time effects for Fire, Freeze, Poison, Electric and Bleeding length"
	upgradeDescription(1)="+%x%% Fire, Toxic, Freeze and Sonic Damage Resistance"
	upgradeDescription(2)="+%x%% Damage with <font color=\"#caab05\">Fire, Freeze, Poison, Electric and Bleeding weapons and statuses</font>"
	...
	PerkBonus(1)=(baseValue=0, incValue=03, maxValue=-1)
	...
	Name="Default__ZRUpgrade_Perk_Scientist"
}
